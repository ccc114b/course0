"""Test suite for r4py package"""

import pytest
from r4py.distributions import dnorm, pnorm, qnorm, rnorm
from r4py.stats import mean, median, var, sd
from r4py.tests import t_test, z_test

...
class Plane:
    ...
    def line_intersection(self, line: Line) -> Point | None:
    ...
    @classmethod
    def from_points(cls, p1: Point, p2: Point, p3: Point) -> "Plane":
    ...
    def is_parallel_to(self, other: "Plane", tol: float = 1e-9) -> bool:
        """Check if planes are parallel."""
        if not isinstance(other, Plane):
            return False
        return self._normal.is_parallel(other._normal, tol)

    def is_perpendicular_to(self, other: "Plane", tol: float = 1e-9) -> bool:
